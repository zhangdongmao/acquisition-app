...
<template>
  <div>
    ...
    <el-breadcrumb>
      ...
      <el-breadcrumb-item>DW脚本生成</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-select v-model="value" clearable placeholder="请选择业务系统" size="mini">
            <el-option
        ...
        <el-col :span="12">         
          <el-button size="mini" type="primary" class="btn" @click="getStatus()">初始化脚本</el-button>          
        </el-col>
      </el-row>
      <el-table
        height="387"
...
<script>
import mixin from './generateDWScript-Mixin'
export default {
  mixins: [mixin]
}
</script>
